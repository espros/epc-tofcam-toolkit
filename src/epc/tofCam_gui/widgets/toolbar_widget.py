...
class ToolBar(QToolBar):
    def __init__(self, parent=None):
        ...
        # Button actions
        self.playButton.triggered.connect(lambda: self.__setOnOffIcons(
            self.playButton, self._icons["play"], self._icons["stop"]))

        self.playButton.toggled.connect(
            lambda checked: self.captureButton.setEnabled(not checked))

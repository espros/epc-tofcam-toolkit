...
_SVG_DICT = {
    ...
    "pause": """<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="#FFC107"  class="icon icon-tabler icons-tabler-filled icon-tabler-player-pause"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 4h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h2a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2z" /><path d="M17 4h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h2a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2z" /></svg>""",
    ...
    "replay": """<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-shareplay"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 18a3 3 0 0 0 3 -3v-8a3 3 0 0 0 -3 -3h-12a3 3 0 0 0 -3 3v8a3 3 0 0 0 3 3" /><path d="M9 20h6l-3 -5z" /></svg>""",
...
class ToolBar(QToolBar):
    def __init__(self, parent=None):
        ...
        self.recordButton = QAction(self._icons["record"], "Capture", self, toolTip="Record live stream", checkable=True)
        self.replayButton = QAction(self._icons["replay"], "Replay", self, toolTip="Replay a recorded stream", checkable=True)
    ...
    def _replayButtonToggled(self) -> None:
        ...
        QTimer.singleShot(100, lambda: self.playButton.setEnabled(not self.replayButton.isChecked()))
        QTimer.singleShot(100, lambda: self.captureButton.setEnabled(not self.replayButton.isChecked()))
        QTimer.singleShot(100, lambda: self.recordButton.setEnabled(not self.replayButton.isChecked()))

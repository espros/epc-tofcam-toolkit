...
class ToolBar(QToolBar):
    def __init__(self, parent=None):
        ...
        self._startIcon = parent.style().standardIcon(
        ...
        self.playButton.triggered.connect(lambda: self.__setIcon(
            self.playButton, self._startIcon, self._stopIcon))

        # assemble capture button
        self._captureIcon = parent.style().standardIcon(

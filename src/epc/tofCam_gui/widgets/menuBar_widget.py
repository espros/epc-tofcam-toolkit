...
class MenuBar(QMenuBar):
    def __init__(self, parent=None):
        ...
        self.outOfRangeMaskAction = QAction("Mask", self)
        self.outOfRangeMaskAction.setCheckable(True)
        self.outOfRangeMaskAction.setChecked(True)

...
class GUI_TOFcam635(Base_GUI_TOFcam):
    def __init__(self, title='TOF CAM 635 VIDEO STREAM', parent=None):
        ...
        self.integrationTimes = IntegrationTimes(['WFOV1', 'WFOV2', 'WFOV3', 'WFOV4', 'Gray'], [125, 250, 375, 500, 50], [1000, 1000, 1000, 1000, 50000])
        ...
        self.temporalFilter = TemporalFilter(range_treshold=(0, 100), factor=0.1, treshold=300)
